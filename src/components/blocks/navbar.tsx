    ...
    dropdownItems: [
      {
        ...
        href: '/blogs/#feature-modern-teams',
        description:
          'Mainline is built on the habits that make the best product teams successful',
      },
      {
        title: 'Resource Allocation',
        href: '/blogs/#resource-allocation',
        description: 'Mainline your resource allocation and execution',
      },
    ],
  },
  { label: 'About Us', href: '/blogs/about' },
  { label: 'Pricing', href: '/blogs/pricing' },
  { label: 'FAQ', href: '/blogs/faq' },
  { label: 'Contact', href: '/blogs/contact' },
]
    ...
    >
      <div className='flex items-center justify-between px-6 py-3'>
        ...
        <div className='flex items-center gap-2.5'>
          <ThemeSwitch />
          <Link to='/clerk/sign-in' className='max-lg:hidden'>
